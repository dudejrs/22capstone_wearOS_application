package com.example.capstone_wearos_application_watchfaces
 ...
 */
class KBWatchFaceAnalog : CanvasWatchFaceService() {

    override fun onCreateEngine(): Engine {
        return Engine()
    }

    private class EngineHandler(reference: KBWatchFaceAnalog.Engine) : Handler() {
        private val mWeakReference: WeakReference<KBWatchFaceAnalog.Engine> =
    ...
    inner class Engine : CanvasWatchFaceService.Engine() {
        ...
        /* custom drawable*/
        private lateinit var mProgressBar: Paint
        private lateinit var mTickAndCirclePaint2: Paint
        private var colorMap = IntArray(2)
        private var positionMap = FloatArray(2)
        private var mwidth = 0f
        private var mheight = 0f
        private var stock_cur : StockData? = null
        private var stockStamps = Array<Int?>(2){null;null}
        ...
        override fun onCreate(holder: SurfaceHolder) {
            ...
            setWatchFaceStyle(
                WatchFaceStyle.Builder(this@KBWatchFaceAnalog)
        ...
        private fun initializeWatchFace() {
            ...
            colorMap[0] = Color.parseColor("#0ABFBC")
            colorMap[1] = Color.parseColor("#FC354C")
            positionMap[0] = 0f
            positionMap[1] = 1f
            ...
            mTickAndCirclePaint2 = Paint().apply {
                color = mWatchHandColor
...
//            }
        ...
        private fun drawWatchFace(canvas: Canvas) {
            /*
           Draw smaller ticks and Progress Bar
             */
            canvas.rotate(90f,mCenterX,mCenterY)
            mProgressBar.shader = SweepGradient(160f, 160f, colorMap,positionMap)
            canvas.drawCircle(mCenterX,mCenterY,mCenterX,mProgressBar)
            canvas.rotate(-90f,mCenterX,mCenterY)
//            mTickAndCirclePaint.alpha = 80
            ...
            for (tickIndex in 0..59) {
                ...
                canvas.drawLine(
                    ...
                    mCenterX + outerX, mCenterY + outerY, mTickAndCirclePaint2
                )
            }
//            mTickAndCirclePaint.alpha = 100
            /*
...
//                mCalendar.get(Calendar.SECOND) + mCalendar.get(Calendar.MILLISECOND) / 1000f
            ...
            // custom
            val seconds = (stockStamps[1]?.minus(stock_cur!!.bp))!!.toFloat() / (stock_cur!!.bp).toFloat() * 100
            Log.d("app:WatchFace:onDraw"," ${stock_cur!!.stockName} $seconds")
        ...
        private fun registerReceiver() {
            ...
            this@KBWatchFaceAnalog.registerReceiver(mTimeZoneReceiver, filter)
        }
        ...
        private fun unregisterReceiver() {
            ...
            this@KBWatchFaceAnalog.unregisterReceiver(mTimeZoneReceiver)
        }
        ...
        // Custom
//        private fun handleUpdateStockMessage(){
//
//        }
        ...
        private suspend fun initStock(){
            ...
            val job = scope.launch{
                stock_cur = db!!.stockdataDAO().getAll()[0]
                stockStamps[0] = stock_cur!!.price
                stockStamps[1] = stock_cur!!.price

            }
            job.join()

            Log.d("app:WatchFace", " ${stock_cur!!.stockName} ${stock_cur!!.price} ${stock_cur!!.bp}")
        }
...
//                stock_cur = db!!.stockdataDAO().getAll()[0]
                ...
                var temp = stockStamps[0]
                stockStamps[0] = stockStamps[1]
                stockStamps[1] = stock_cur!!.bp - pow(-1.0, rand.nextInt(0,10).toDouble()).toInt() *(rand.nextInt(0, (stock_cur!!.bp * 0.03f*10).toInt() ))
